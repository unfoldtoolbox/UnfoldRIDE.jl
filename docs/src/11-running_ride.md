...
You can find the code for this tutorial [here](https://github.com/unfoldtoolbox/UnfoldRIDE.jl/blob/main/docs/code/simulate_variable_latency_sequence.jl), using this [Project.toml](https://github.com/unfoldtoolbox/UnfoldRIDE.jl/blob/main/docs/code/Project.toml).
...
![Results for Classic and Unfold RIDE](https://github.com/unfoldtoolbox/UnfoldRIDE.jl/blob/main/docs/images/simulated_EEG_tutorial.png "Results of running Classic and Unfold RIDE on the simulated dataset.")
