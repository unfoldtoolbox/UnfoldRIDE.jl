...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/unfoldtoolbox/UnfoldRIDE.jl
   ```
...
- After that runs, the [stable docs](https://unfoldtoolbox.github.io/UnfoldRIDE.jl/stable) should be updated. Check them and look for the version number.
