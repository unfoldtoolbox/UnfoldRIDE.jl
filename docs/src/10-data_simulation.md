...
![simulated_eeg_graph](https://github.com/unfoldtoolbox/UnfoldRIDE.jl/blob/main/docs/images/classicAndUnfoldTutorialResults.png "Simulated EEG data with two variable latency components, C and R")
